module.exports = {
  ...
  name: "get_list_of_transaction_of_a_order",

  title: "Get List Of Transaction Of A Order",
...
ids: {
 ...
 var x="https://api.bigcommerce.com/stores/"+input.auth.hash+"/v3/orders/"+input.ids+"/transactions";
 var y= input.auth.cs;
